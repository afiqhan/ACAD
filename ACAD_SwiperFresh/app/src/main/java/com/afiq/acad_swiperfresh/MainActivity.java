package com.afiq.acad_swiperfresh;
...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList <Integer>images = new ArrayList<>(Arrays.asList(R.drawable.facebook, R.drawable.x,R.drawable.youtube,R.drawable.linkedin,
            R.drawable.instagram, R.drawable.whatsapp));
    ArrayList <String> text = new ArrayList<>(Arrays.asList("Facebook", "X", "YouTube", "Linkedin", "Instagram", "Whatsapp"));
